(function(){
    var modules={
        ...
        "consent-data":                  {url:"$H/m/library/consent-data.html",Table:"consent-bod1",form_module:"consent-form",task_name:"Baseline - Informed Consent"},
        "consent-form":                  {url:"$H/m/library/consent-form.html",Table:"consent-bod1",task_name:"Baseline - Informed Consent"},
        ...
        "drug-bl-data":                  {url:"$H/m/library/drug-data.html",Table:"drug-bl-bod1",form_module:"drug-bl-form",task_name:"Baseline - Drug dose and details related to their treatment plan"},
        "drug-bl-form":                  {url:"$H/m/library/drug-form.html",Table:"drug-bl-bod1",task_name:"Baseline - Drug dose and details related to their treatment plan"},
        "c19-yrs-bl-data":                  {url:"$H/m/library/c19-yrs-data.html",Table:"c19-yrs-bl-bod1",form_module:"c19-yrs-bl-form",task_name:"Baseline - COVID-19 Yorkshire Rehabilitation Scale (C19-YRS)"},
        "c19-yrs-bl-form":                  {url:"$H/m/library/c19-yrs-form.html",Table:"c19-yrs-bl-bod1",task_name:"Baseline - COVID-19 Yorkshire Rehabilitation Scale (C19-YRS)"},
        ...
        "drug-1-data":                  {url:"$H/m/library/drug-data.html",Table:"drug-1-bod1",form_module:"drug-1-form",task_name:"Month 1 - Drug dose and details related to their treatment plan"},
        "drug-1-form":                  {url:"$H/m/library/drug-form.html",Table:"drug-1-bod1",task_name:"Month 1 - Drug dose and details related to their treatment plan"},
        "c19-yrs-1-data":                  {url:"$H/m/library/c19-yrs-data.html",Table:"c19-yrs-1-bod1",form_module:"c19-yrs-1-form",task_name:"Month 1 - COVID-19 Yorkshire Rehabilitation Scale (C19-YRS)"},
        "c19-yrs-1-form":                  {url:"$H/m/library/c19-yrs-form.html",Table:"c19-yrs-1-bod1",task_name:"Month 1 - COVID-19 Yorkshire Rehabilitation Scale (C19-YRS)"},
        ...
        "drug-2-data":                  {url:"$H/m/library/drug-data.html",Table:"drug-2-bod1",form_module:"drug-2-form",task_name:"Month 2 - Drug dose and details related to their treatment plan"},
        "drug-2-form":                  {url:"$H/m/library/drug-form.html",Table:"drug-2-bod1",task_name:"Month 2 - Drug dose and details related to their treatment plan"},
        "c19-yrs-2-data":                  {url:"$H/m/library/c19-yrs-data.html",Table:"c19-yrs-2-bod1",form_module:"c19-yrs-2-form",task_name:"Month 2 - COVID-19 Yorkshire Rehabilitation Scale (C19-YRS)"},
        "c19-yrs-2-form":                  {url:"$H/m/library/c19-yrs-form.html",Table:"c19-yrs-2-bod1",task_name:"Month 2 - COVID-19 Yorkshire Rehabilitation Scale (C19-YRS)"},
        ...
        "drug-3-data":                  {url:"$H/m/library/drug-data.html",Table:"drug-3-bod1",form_module:"drug-3-form",task_name:"Month 3 - Drug dose and details related to their treatment plan"},
        "drug-3-form":                  {url:"$H/m/library/drug-form.html",Table:"drug-3-bod1",task_name:"Month 3 - Drug dose and details related to their treatment plan"},
        "c19-yrs-3-data":                  {url:"$H/m/library/c19-yrs-data.html",Table:"c19-yrs-3-bod1",form_module:"c19-yrs-3-form",task_name:"Month 3 - COVID-19 Yorkshire Rehabilitation Scale (C19-YRS)"},
        "c19-yrs-3-form":                  {url:"$H/m/library/c19-yrs-form.html",Table:"c19-yrs-3-bod1",task_name:"Month 3 - COVID-19 Yorkshire Rehabilitation Scale (C19-YRS)"},
        ...
        "drug-4-data":                  {url:"$H/m/library/drug-data.html",Table:"drug-4-bod1",form_module:"drug-4-form",task_name:"Month 4 - Drug dose and details related to their treatment plan"},
        "drug-4-form":                  {url:"$H/m/library/drug-form.html",Table:"drug-4-bod1",task_name:"Month 4 - Drug dose and details related to their treatment plan"},
        "c19-yrs-4-data":                  {url:"$H/m/library/c19-yrs-data.html",Table:"c19-yrs-4-bod1",form_module:"c19-yrs-4-form",task_name:"Month 4 - COVID-19 Yorkshire Rehabilitation Scale (C19-YRS)"},
        "c19-yrs-4-form":                  {url:"$H/m/library/c19-yrs-form.html",Table:"c19-yrs-4-bod1",task_name:"Month 4 - COVID-19 Yorkshire Rehabilitation Scale (C19-YRS)"},
        ...
        "drug-5-data":                  {url:"$H/m/library/drug-data.html",Table:"drug-5-bod1",form_module:"drug-5-form",task_name:"Month 5 - Drug dose and details related to their treatment plan"},
        "drug-5-form":                  {url:"$H/m/library/drug-form.html",Table:"drug-5-bod1",task_name:"Month 5 - Drug dose and details related to their treatment plan"},
        "c19-yrs-5-data":                  {url:"$H/m/library/c19-yrs-data.html",Table:"c19-yrs-5-bod1",form_module:"c19-yrs-5-form",task_name:"Month 5 - COVID-19 Yorkshire Rehabilitation Scale (C19-YRS)"},
        "c19-yrs-5-form":                  {url:"$H/m/library/c19-yrs-form.html",Table:"c19-yrs-5-bod1",task_name:"Month 5 - COVID-19 Yorkshire Rehabilitation Scale (C19-YRS)"},
        ...
        "drug-6-data":                  {url:"$H/m/library/drug-data.html",Table:"drug-6-bod1",form_module:"drug-6-form",task_name:"Month 6 - Drug dose and details related to their treatment plan"},
        "drug-6-form":                  {url:"$H/m/library/drug-form.html",Table:"drug-6-bod1",task_name:"Month 6 - Drug dose and details related to their treatment plan"},
        "c19-yrs-6-data":                  {url:"$H/m/library/c19-yrs-data.html",Table:"c19-yrs-6-bod1",form_module:"c19-yrs-6-form",task_name:"Month 6 - COVID-19 Yorkshire Rehabilitation Scale (C19-YRS)"},
        "c19-yrs-6-form":                  {url:"$H/m/library/c19-yrs-form.html",Table:"c19-yrs-6-bod1",task_name:"Month 6 - COVID-19 Yorkshire Rehabilitation Scale (C19-YRS)"},
        ...
        "drug-eos-data":                  {url:"$H/m/library/drug-data.html",Table:"drug-eos-bod1",form_module:"drug-eos-form",task_name:"End of Study - Drug dose and details related to their treatment plan"},
        "drug-eos-form":                  {url:"$H/m/library/drug-form.html",Table:"drug-eos-bod1",task_name:"End of Study - Drug dose and details related to their treatment plan"},
        "c19-yrs-eos-data":                  {url:"$H/m/library/c19-yrs-data.html",Table:"c19-yrs-eos-bod1",form_module:"c19-yrs-eos-form",task_name:"End of Study - COVID-19 Yorkshire Rehabilitation Scale (C19-YRS)"},
        "c19-yrs-eos-form":                  {url:"$H/m/library/c19-yrs-form.html",Table:"c19-yrs-eos-bod1",task_name:"End of Study - COVID-19 Yorkshire Rehabilitation Scale (C19-YRS)"},
